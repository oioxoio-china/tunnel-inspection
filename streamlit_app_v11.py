...
# --- 1. 页面与样式配置 ---
st.set_page_config(
    page_title="隧道工程检验批划分系统 Pro v11.0",
    page_icon="🚇",
    layout="wide",
...
def get_tb10417_db():
    ...
    data = [
        ...
        {"分部工程": "06 洞口工程", "分项工程": "回填", "条款号": "6.5.3", "性质": "一般项目", "核心内容": "分层回填厚度符合设计要求，总厚度允许偏差+5cm。"},
        ...
        {"分部工程": "08 支护", "分项工程": "钢筋网", "条款号": "8.7.3", "性质": "一般项目", "核心内容": "表面无严重锈蚀，焊点无脱落。"},
        {"分部工程": "08 支护", "分项工程": "系统锚杆", "条款号": "8.8.1~8.8.3", "性质": "主控项目", "核心内容": "类型、规格、数量符合设计；胶结及锚固长度符合要求。"},
        {"分部工程": "08 支护", "分项工程": "系统锚杆", "条款号": "8.8.4~8.8.5", "性质": "一般项目", "核心内容": "钻孔允许偏差符合要求；垫板与基面密贴。"},
        {"分部工程": "08 支护", "分项工程": "钢架", "条款号": "8.9.1~8.9.3", "性质": "主控项目", "核心内容": "规格、材质、数量符合设计；基础牢固、连接符合设计。"},
        {"分部工程": "08 支护", "分项工程": "钢架", "条款号": "8.9.4", "性质": "一般项目", "核心内容": "钢架安装允许偏差（横向、垂直度、间距）符合要求。"},
        {"分部工程": "09 衬砌", "分项工程": "仰拱(底板)和填充", "条款号": "9.2.1~9.2.6", "性质": "主控项目", "核心内容": "基底清理、尺寸、钢筋、预埋件、强度、抗渗、密实度符合设计。"},
        {"分部工程": "09 衬砌", "分项工程": "仰拱(底板)和填充", "条款号": "9.2.7~9.2.8", "性质": "一般项目", "核心内容": "高程允许偏差±10mm；表面平顺，排水通畅。"},
        {"分部工程": "09 衬砌", "分项工程": "拱墙衬砌", "条款号": "9.3.1~9.3.7", "性质": "主控项目", "核心内容": "净空断面、钢筋规格、强度、厚度及密实度符合设计要求。"},
        {"分部工程": "09 衬砌", "分项工程": "拱墙衬砌", "条款号": "9.3.8~9.3.10", "性质": "一般项目", "核心内容": "保护层厚度、预留孔偏差符合要求；表面密实无蜂窝孔洞。"},
        {"分部工程": "10 防排水", "分项工程": "防水板", "条款号": "10.3.1~10.3.5", "性质": "主控项目", "核心内容": "材质、基面平顺度、搭接宽度、焊缝质量符合设计要求。"},
        {"分部工程": "10 防排水", "分项工程": "防水板", "条款号": "10.3.6~10.3.7", "性质": "一般项目", "核心内容": "阴阳角应做成R≥10cm圆弧面；缓冲层接缝搭接宽度不得小于5cm。"},
        {"分部工程": "10 防排水", "分项工程": "施工缝", "条款号": "10.5.1~10.5.3", "性质": "主控项目", "核心内容": "止水带材质、连接方式符合设计；遇水膨胀止水条搭接不小于50mm。"},
        {"分部工程": "10 防排水", "分项工程": "施工缝", "条款号": "10.5.4", "性质": "一般项目", "核心内容": "止水带安装径向位置允许偏差±20mm，纵向偏离中心±30mm。"},
        {"分部工程": "10 防排水", "分项工程": "排水盲管", "条款号": "10.7.1~10.7.4", "性质": "主控项目", "核心内容": "盲管品种规格符合设计；不应低于水沟底面高程；连接牢固、畅通无阻。"},
        {"分部工程": "10 防排水", "分项工程": "排水盲管", "条款号": "10.7.5", "性质": "一般项目", "核心内容": "纵横向盲管的坡度应符合设计要求。"}
    ]
...
def main():
    ...
    # ===== 页面：标准查阅 =====
        ...
        st.info("依据《TB 10417-2018》附录B及正文核心条款整理，可直接搜索条款号或内容关键词。")
        
        db_df = get_tb10417_db()
        
        search_query = st.text_input("🔍 搜索标准条款 (支持输入分项名称、条文号或验收内容)", "")
        
        if search_query:
            mask = db_df.apply(lambda row: row.astype(str).str.contains(search_query, case=False).any(), axis=1)
            filtered_df = db_df[mask]
        else:
            filtered_df = db_df
